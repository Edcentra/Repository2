...
namespace Edwards.Scada.Test.Framework.GlobalHelper
{
    public class Simulator
    {
        ...
        public void SetPin(int pin)
        {
            ...
            //    agentConfiguration = application.GetWindow("Agent Configuration");
            var fileMenu = agentConfiguration.MenuBar;
            string[] filePath = { "File", "Admin Mode" };
            Thread.Sleep(1000);
            fileMenu.MenuItem(filePath).Click();
            Thread.Sleep(1000);
            agentConfiguration.Get(SearchCriteria.ByAutomationId("textBoxPIN")).Enter(Convert.ToString(pin));
            Thread.Sleep(1000);
        }
        ...
        public void LaunchandStartVISimulator()
        {
            ...
            pid = process.Id;
            simulatorWindow = application.GetWindow(GlobalConstants.ViSimulatorWindow);// SearchCriteria.ByAutomationId("TitleBar"), InitializeOption.NoCache);
            Thread.Sleep(2000);
        ...
        public void RaiseAlert(string parameter, string alerType = "HighAlarm", string alertCode = "IDS_25_ALERT_1_0 (System configuration fault)")
        {
