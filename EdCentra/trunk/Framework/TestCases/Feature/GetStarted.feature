...
Then A window should show containing information about the current user 'EdCentra','Admin', 'user@domain.com'
...
@SingleServer
@EnableFingerPrint
Scenario: A Enable Fingerprint for administrator
Given opened EDCENTRA app 
...
When I login username as 'administrator' and password as 'toolkit'
