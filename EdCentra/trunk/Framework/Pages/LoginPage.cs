...
namespace Edwards.Scada.Test.Framework.Pages
{
    ...
    public class LoginPage : PageBase
    {
        ...
        //about-close
        [FindsBy(How = How.XPath, Using = "//div[contains(@id,'divpopAbout_btnClose')]//input[contains(@id,'popAbout_btnClose')]")]
        private IWebElement btnCloseAbout;

        //activate-close 
        [FindsBy(How = How.Id, Using = "lnkCancelActivation")]
