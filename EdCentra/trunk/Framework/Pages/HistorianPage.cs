        ...
        public void SelectSingleParameterEquipment(string Equipment)
        {
            ...
            for (int i = 0; i < 30; i++)
            {
               ...
               List<IWebElement> lstEle = new List<IWebElement>(lnkSingleSystem.FindElements(By.TagName("span")));
                //  List<IWebElement> lstEle = new List<IWebElement>(lnkSingleSystem.FindElements(By.ClassName("unselectable")));
               // List<IWebElement> lstEle = new List<IWebElement>(lnkSingleSystem.FindElements(By.Id("ctl00_ctl00_cphContent_cphContent_SystemTreeView1_TreeView1")));
