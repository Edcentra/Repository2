...
namespace Edwards.Scada.Test.Framework.Pages
{
    public class UserPage : PageBase
    {
        ...
        [FindsBy(How = How.Id, Using = "divctl00_ctl00_cphContent_cphContent_btnApply")]
        private IWebElement btnApplyOnPermTab;
        ...
        //ctl00_ctl00_cphContent_cphContent_lnkPerms
        [FindsBy(How = How.Id, Using = "ctl00_ctl00_cphContent_cphContent_lnkPerms")]
        private IWebElement clickPermissionTab;        
        ...
        //ctl00_ctl00_cphContent_cphContent_rptUsers_ctl00_btnEdit
        [FindsBy(How = How.Id, Using = "ctl00_ctl00_cphContent_cphContent_rptUsers_ctl00_btnEdit")]
        private IWebElement adminEdCentra;
      ...
      //  private IWebElement lblconfimationMessage; 
        ...
        public IWebElement BtnApplyOnPermTab
        {
            get { return btnApplyOnPermTab; }
            set { btnApplyOnPermTab = value; }
        }

        public IWebElement ClickPermissionTab
        {
            get { return clickPermissionTab; }
            set { clickPermissionTab = value; }
        }
        public IWebElement AdminEdCentra
        {
            get { return adminEdCentra; }
            set { adminEdCentra = value; }
        }
        ...
        public void ClickOnApplyChanges()
        {
            //  Waits.WaitAndClick(driver, btnApplyChange);
            Thread.Sleep(2000);
            driver.FindElement(By.Id("ctl00_ctl00_cphContent_cphContent_btnApply")).Click();
        ...
        {
            IList<IWebElement> Exstusers = driver.FindElements(By.Id("ctl00_ctl00_cphContent_cphContent_rptUsers_ctl00_liEdit"));
            int totalcount = Exstusers.Count;
            if (totalcount > 1)
            {
                for (int i = 10; i < totalcount; i++)
                {
                    Actions a = new Actions(driver);

                   a.Click(Exstusers[0]).KeyDown(Keys.Shift).Click(Exstusers.Last()).KeyUp(Keys.Control).Build().Perform();
                    Thread.Sleep(3000);
                    driver.FindElement(By.Id("ctl00_ctl00_cphContent_cphContent_btnDelete")).Click();
                    Thread.Sleep(5000);
                    driver.FindElement(By.Id("ctl00_ctl00_cphContent_cphContent_btnOKDelete")).Click();
